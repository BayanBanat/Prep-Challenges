...
let count=obj.reduce((accomulater) => accomulater + 1, 0)
return count;
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
    // write your code here
    let splitString=str.split(' ').reduceRight((comulator,currentValue)=>
    comulator + ' ' + currentValue
)
return splitString
...
const statistics = (obj) => {
    ...
    let res=obj.reduce((comulator,obj)=>{
        if(obj.votes_To in comulator){
            comulator[obj.votes_To]++;

        }else{
            comulator[obj.votes_To]=1;
        }
        return comulator;
